...
import com.example.itmlibrary.MainActivity;
...
public class PhoneVerification extends AppCompatActivity implements View.OnClickListener {
                            ...
                            .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        editor1.apply();
                                        Firebase reference = new Firebase("https://itm-library.firebaseio.com/Users");
                                        ...
                                        reference.child(phone).child("Phone").setValue(phone);
                                            ...
                                            sendNotification("Registration Successful", "Welcome to ITM Library !!");
                                            Toast.makeText(PhoneVerification.this, "Registration Successful", Toast.LENGTH_LONG).show();
                                        Intent verificationIntent = new Intent(PhoneVerification.this, LoginActivity.class);
    ...
    public void sendNotification(String title, String message) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this, CHANNEL_ID)
                .setSmallIcon(R.drawable.itm_logo)
