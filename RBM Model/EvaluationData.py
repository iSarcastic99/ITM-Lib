...
class EvaluationData:
    ...
    def __init__(self, data, popularityRankings):
        ...
        #Building a full training set for evaluation
        ...
        #Building an anti-test-set for building predictions
        ...
        #Computing similarty matrix between items so we can measure diversity
